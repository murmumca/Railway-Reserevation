<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PNR Stat.aspx.cs" Inherits="PNR_Stat" %>
...
<!DOCTYPE html>
    ...
    <!-- Insert to your webpage where you want to display the slider -->
                        <div id="amazingslider-1" style="display:block;position:relative;margin:16px auto 56px;">
                            <ul class="amazingslider-slides" style="display:none;">
                                ...
                                <li>
                                    <img alt="shinkansen_bullet_train_and_mount_fuji_japan-wallpaper-1366x768" src="images/shinkansen_bullet_train_and_mount_fuji_japan-wallpaper-1366x768.jpg" /></li>
                                <li>
                                    <img alt="train-hd-images" src="images/train-hd-images.jpg" /></li>
                                <li>
                            ...
                            <ul class="amazingslider-thumbnails" style="display:none;">
                                ...
                                <li>
                                    <img src="images/shinkansen_bullet_train_and_mount_fuji_japan-wallpaper-1366x768-tn.jpg" /></li>
                                <li>
                                    <img src="images/train-hd-images-tn.jpg" /></li>
                                <li>
                            ...
                            <div class="amazingslider-engine" style="display:none;">
                                <a href="http://amazingslider.com" title="JavaScript Slideshow">JavaScript Slideshow</a></div>
                        </div>
    <!-- End of body section HTML codes -->
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="Label1" runat="server" style="font-weight: 700; font-size: x-large; color: #6600FF" Text="Reservation Current Status"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:Label ID="Label2" runat="server" style="font-weight: 700; font-size: medium" Text="Enter the PNR NO of the ticket to know the exact status of the Reservation"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="auto-style43">
                    <asp:Label ID="Label3" runat="server" style="font-weight: 700" Text="PNR NO"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style43"><input type="button" onclick="printt();" value="print" />
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="font-weight: 700" Text="Get Status" />
                </td>
                <td>
            ...
            <tr>
                <td colspan="2">
                    <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/Home.aspx" style="font-weight: 700">Back</asp:HyperLink>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
            </tr>
        </table>
    </form>
