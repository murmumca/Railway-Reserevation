<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Seat Avilability.aspx.cs" Inherits="Seat_Avilability" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style42">
            <tr>
                <td colspan="2" style="text-align: center; font-weight: 700; font-size: x-large; color: #6600FF">Seat Availability</td>
            </tr>
            <tr>
                <td>
<!DOCTYPE html>
                    ...
                    <table class="auto-style42">
                        ...
                        <tr>
                            ...
                            <td class="auto-style44">
                                ...
                                (Check Availability from Current Day to Next 5 Days)</td>
                        </tr>
                        <tr>
                            <td class="auto-style45" colspan="2" style="background-color: #FFCC00">
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="font-weight: 700" Text="Check" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
