<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rajdhani1.aspx.cs" Inherits="Rajdhani1" %>
...
<body>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style17">12453</td>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style4">17:10</td>
            <td class="auto-style4">0 km</td>
            <td class="auto-style4">JH</td>
        </tr>
        <tr>
            <td class="auto-style17">DALTONGANJ</td>
            <td class="auto-style15">DTO</td>
            <td class="auto-style17">22:03</td>
            <td class="auto-style17">22:05</td>
            <td class="auto-style17">305 km</td>
            <td class="auto-style17">JH</td>
        </tr>
        <tr>
            <td class="auto-style15">GARWA ROAD</td>
            <td class="auto-style15">GHD</td>
            <td class="auto-style15">22:50</td>
            <td class="auto-style15">22:55</td>
            <td class="auto-style15">339 km</td>
        ...
        <tr>
            ...
            <td class="auto-style17">555 km</td>
        ...
        <tr>
            ...
            <td class="auto-style17">902 km</td>
            <td class="auto-style17">UP</td>
        </tr>
        <tr>
            <td class="auto-style17">NEW DELHI</td>
            ...
            <td class="auto-style17">1341 km</td>
